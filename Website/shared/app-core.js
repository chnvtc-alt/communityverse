(() => {
  ...
  const RESTAURANT_SLUG_ALIASES = {
    ...
    "cinema tavern": "cinema-tavern",
    "gabes-downtown": "gabes",
    "gabe-s-downtown": "gabes",
    "gabe's downtown": "gabes",
    "the-rusty-bike-cafe": "rustybike",
    "rusty-bike-cafe": "rustybike",
    "the rusty bike cafe": "rustybike",
  };
  ...
  const restaurants = [
    ...
    },
    {
      ...
      description: "Play the Waffle Master Restaurant Challenge trivia game.",
      heroImage: "/assets/restaurant-challenge/restaurants/wafflemaster/wafflemaster-hero.jpg",
      logoSquare: "/assets/restaurant-challenge/restaurants/wafflemaster/wafflemaster-logo.jpg",
      logoHorizontal: "/assets/restaurant-challenge/restaurants/wafflemaster/wafflemaster-logo.jpg",
      squareImage: "/assets/restaurant-challenge/restaurants/wafflemaster/wafflemaster-logo.jpg",
      active: true,
      playable: true,
      visibleInList: true,
    },
    ...
    },
    {
      ...
      slug: "fabianos",
      name: "Fabiano's",
      publicGameName: "The Fabiano's Game",
      description: "Play the Fabiano's Restaurant Challenge trivia game.",
      active: true,
      playable: true,
      visibleInList: true,
    },
    {
      id: "gabes",
      slug: "gabes",
      name: "Gabe's Downtown",
      publicGameName: "The Gabe's Downtown Game",
      description: "Play the Gabe's Downtown Restaurant Challenge trivia game.",
      active: true,
      playable: true,
      visibleInList: true,
    },
    {
      id: "rustybike",
      slug: "rustybike",
      name: "The Rusty Bike Cafe",
      publicGameName: "The Rusty Bike Cafe Game",
      description: "Play The Rusty Bike Cafe Restaurant Challenge trivia game.",
      active: true,
      playable: true,
      visibleInList: true,
    },
    {
      ...
      slug: "nkscafe",
      name: "N.K.'s Cafe",
      publicGameName: "The N.K.'s Cafe Game",
      description: "Play the N.K.'s Cafe Restaurant Challenge trivia game.",
      active: true,
      playable: true,
      visibleInList: true,
    },
  ...
  function buildGeneratedDemoProfiles(targetCount = 100) {
    ...
    const adjectivePool = [
      ...
      "Applewood", "Briar", "Brookside", "Cedar", "Cherrywood", "Chestnut", "Dogwood", "Evergreen", "Farmhouse",
      "Fernwood", "Harbor", "Honeybee", "Ironwood", "Juniper", "Lakeshore", "Old Mill", "Orchard", "Peachtree",
      "Railway", "Ridgeview", "Riverstone", "Seaside", "Stonebridge", "Sycamore", "Waterwheel"
    ];
    const nounPool = [
      ...
      "Ale House", "Biscuit House", "Boardwalk", "Burger Bar", "Canteen", "Chophouse", "Clubhouse", "Coffee House",
      "Dining Room", "Dockside", "Fish Camp", "Food Hall", "Hot Plate", "Juke Joint", "Meat Market", "Patio",
      "Pizza Kitchen", "Rib Shack", "Saloon", "Seafood House", "Short Order", "Slice Shop", "Taproom", "Village Table"
    ];
  ...
  function getProfileEarnedPointTotal(profile) {
    return Math.max(
      0,
      Number(profile?.stats?.estimatedSales) || 0,
      getRestaurantStatsEarnedTotal(profile)
    );
  }
  ...
  function awardFeedbackReward(restaurantSlug, options = {}) {
    ...
    const previousEarnedPoints = getProfileEarnedPointTotal(nextProfile);
    const rewardSession = {
      restaurantSlug: restaurant.slug,
      restaurantName: restaurant.name,
      result: "regular",
    ...
    const cashEarned = Math.max(
      0,
      getProfileEarnedPointTotal(rebuiltProfile) - previousEarnedPoints
    );
